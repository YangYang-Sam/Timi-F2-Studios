...
//给空间添加监听事件要实现的一些接口
public class UI_MyDrag : MonoBehaviour, IPointerDownHandler, IDragHandler, IPointerUpHandler,
    IEndDragHandler
{
    ...
    public void OnPointerDown(PointerEventData eventData)
    {
        ...
        if (isRect)   //如果在
        {
            ...
            RotateObj = UI_MainScene.instance.GalleryInstance.transform;
        }
    }
    ...
    public void OnDrag(PointerEventData eventData)
    {
        ...
        if (isRect)
        {
            ...
            RotateObj.transform.Rotate(new Vector3(0, eventData.delta.x * RotateSpeed, 0));
        }
    }
